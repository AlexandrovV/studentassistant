                    ...
                    <div className={classes.questions}>
                        <Paper className={classes.question}>
                            <Row>
                                ...
                                <Col md={{size: '9', offset: '1'}}>
                                    <Typography variant="title"><Link to="/friend">Groupmate 1</Link></Typography>
                        ...
                        <Paper className={classes.question}>
                            <Row>
                                ...
                                <Col md={{size: '9', offset: '1'}}>
                                    <Typography variant="title"><Link to="/friend">Groupmate 2</Link></Typography>
                                    <Typography variant="body1">Some status...</Typography>
                                    <Link to="/chat">Write a message</Link>
                                </Col>
                            </Row>
                        ...
                        <Paper className={classes.question}>
                            <Row>
                                ...
                                <Col md={{size: '9', offset: '1'}}>
                                    <Typography variant="title"><Link to="/friend">Groupmate 3</Link></Typography>
                                    <Typography variant="body1">Some status...</Typography>
                                    <Link to="/chat">Write a message</Link>
                                </Col>
                            </Row>
                        ...
                        <Paper className={classes.question}>
                            <Row>
                                ...
                                <Col md={{size: '9', offset: '1'}}>
                                    <Typography variant="title"><Link to="/friend">Groupmate 4</Link></Typography>
                                    <Typography variant="body1">Some status...</Typography>
                                    <Link to="/chat">Write a message</Link>
                                </Col>
                            </Row>
                        ...
                        <Paper className={classes.question}>
                            <Row>
                                ...
                                <Col md={{size: '9', offset: '1'}}>
                                    <Typography variant="title"><Link to="/friend">Groupmate 5</Link></Typography>
                                    <Typography variant="body1">Some status...</Typography>
                                    <Link to="/chat">Write a message</Link>
                                </Col>
                            </Row>
...
export default withStyles(styles)(MyGroup);