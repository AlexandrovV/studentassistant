        ...
        <Row>
            <Col md="3">
                <Paper className={classes.avatar}>
                    ...
                    <Button variant="contained" color="primary" className={classes.edit}>Write message</Button>
                </Paper>
            </Col>
            <Col md="9">
                <Paper className={classes.profile}>
                    ...
                    <Paper className={classes.post}>
                        ...
                        <TextField variant="outlined" placeholder="Leave a comment..." fullWidth InputProps={{endAdornment: (
